  ...
  <div>
    <div class="questionnaire-box">
      ...
      <form class="question-box" v-if="isOpen2ndQuestion">
        <p>
          現在、入院中ですか。または、最近3ヶ月以内に医師の診察・検査の結果、入院・手術をすすめられたことはありますか？
        </p>
        <input
          type="radio"
          name="question"
      ...
      <form class="question-box" v-if="isOpen3rdQuestion">
        <p>
          過去５年以内に、病気やけがで、手術をうけたことまたは、継続して７日以上の入院をしたことがありますか？
        </p>
        <input
          type="radio"
          name="question"
